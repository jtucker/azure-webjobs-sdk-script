...
namespace Microsoft.Azure.WebJobs.Script.Tests.Security
{
    public class ScriptSecretSerializerTests
    {
        ...
        {
            using (var variables = new TestScopedEnvironmentVariables(_settingsManager, "AzureWebJobsFeatureFlags", "MultiKey"))
            {
        ...
        {
            using (var variables = new TestScopedEnvironmentVariables(_settingsManager, "AzureWebJobsFeatureFlags", String.Empty))
            {
